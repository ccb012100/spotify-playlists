...
select art.name as artists, a.name as album, a.total_tracks as tracks, substr(a.release_date, 1, 4) as release_date, pt.added_at, p.name as playlist from Album a
